...
Partial Public Class DataSet1
    ...
    Partial Public Class siswaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddsiswaRow(ByVal ID As String, ByVal Nama As String, ByVal Alamat As String, ByVal Telepon As String) As siswaRow
            Dim rowsiswaRow As siswaRow = CType(Me.NewRow,siswaRow)
            Dim columnValuesArray() As Object = New Object() {ID, Nama, Alamat, Telepon}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByID(ByVal ID As String) As siswaRow
            Return CType(Me.Rows.Find(New Object() {ID}),siswaRow)
        End Function
    ...
    Partial Public Class siswaRow
        ...
        Public Property ID() As String
            Get
                Return CType(Me(Me.tablesiswa.IDColumn),String)
            End Get
            Set
                Me(Me.tablesiswa.IDColumn) = value
            End Set
        End Property
        ...
        Public Property Telepon() As String
            Get
                Return CType(Me(Me.tablesiswa.TeleponColumn),String)
            End Get
            Set
                Me(Me.tablesiswa.TeleponColumn) = value
            End Set
        End Property
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class siswaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [siswa] WHERE (([ID] = @Original_ID) AND ((@IsNull_Nama = 1 AND [Nama"& _ 
                "] IS NULL) OR ([Nama] = @Original_Nama)) AND ((@IsNull_Alamat = 1 AND [Alamat] I"& _ 
                "S NULL) OR ([Alamat] = @Original_Alamat)) AND ([Telepon] = @Original_Telepon))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [siswa] ([ID], [Nama], [Alamat], [Telepon]) VALUES (@ID, @Nama, @Alam"& _ 
                "at, @Telepon);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, Nama, Alamat, Telepon FROM siswa WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [siswa] SET [ID] = @ID, [Nama] = @Nama, [Alamat] = @Alamat, [Telepon] = @T"& _ 
                "elepon WHERE (([ID] = @Original_ID) AND ((@IsNull_Nama = 1 AND [Nama] IS NULL) O"& _ 
                "R ([Nama] = @Original_Nama)) AND ((@IsNull_Alamat = 1 AND [Alamat] IS NULL) OR ("& _ 
                "[Alamat] = @Original_Alamat)) AND ([Telepon] = @Original_Telepon));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, "& _ 
                "Nama, Alamat, Telepon FROM siswa WHERE (ID = @ID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.insertpicture.My.MySettings.Default.belajar_insertphotoConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, Nama, Alamat, Telepon"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            siswa"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet1.siswaDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet1.siswaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet1.siswaDataTable = New DataSet1.siswaDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet1.siswaDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As String, ByVal Original_Nama As String, ByVal Original_Alamat As String, ByVal Original_Telepon As String) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_Telepon,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal ID As String, ByVal Nama As String, ByVal Alamat As String, ByVal Telepon As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID As String, ByVal Nama As String, ByVal Alamat As String, ByVal Telepon As String, ByVal Original_ID As String, ByVal Original_Nama As String, ByVal Original_Alamat As String, ByVal Original_Telepon As String) As Integer
            If (ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ID")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Nama As String, ByVal Alamat As String, ByVal Telepon As String, ByVal Original_ID As String, ByVal Original_Nama As String, ByVal Original_Alamat As String, ByVal Original_Telepon As String) As Integer
            Return Me.Update(Original_ID, Nama, Alamat, Telepon, Original_ID, Original_Nama, Original_Alamat, Original_Telepon)
        End Function
    End Class
